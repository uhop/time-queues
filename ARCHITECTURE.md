...
- `waitFor(predicate, options)`: Poll a sync/async predicate until it turns truthy, with a configurable interval (default: 50ms), an optional timeout, and `AbortSignal` support. _(Since version 1.5.0.)_
